...
### Beispiel
Am besten können die Funktionsweisen der drei Funktionen anhand eines Beispiels veranschaulicht werden. Dazu laden wir einen (fiktiven) Datensatz über Prüfungsangst und speichern diesen in der Variable `exam` ab:
...
Berechnen Sie abschließend die Pearson-Korrelation zwischen den Daten beider Messstationen inklusive Konfidenzinterval sowie $p$-Wert.

*Anmerkung 1:* Wandeln Sie die Spalte `Datum` nach dem Einlesen in einen Datums-Typ um.
