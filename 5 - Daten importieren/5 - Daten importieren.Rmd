...
Das Ergebnis sieht gar nicht so falsch aus, nur die erste Zeile, die in der Datei die Variablennamen enthält, wurde fälschlicherweise als Datenzeile erkannt. Dies können wir ändern, indem wir das zusätzliche Argument `header=TRUE` setzen:
...
Der zweite Fall, nämlich die Umwandlung vom Long-Format ins Wide-Format, erfolgt durch die Funktion `dcast`:
